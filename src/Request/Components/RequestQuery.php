...
class RequestQuery implements \ArrayAccess, \Iterator {
	 ...
	 */
	public function __construct(Request $request, array &$data, string $gpcArray) {
	 ...
	 * @return RequestQuery
	 */
	public static function fromGet(Request $request):RequestQuery {
	 ...
	 * @return RequestQuery
	 */
	public static function fromPost(Request $request):RequestQuery {
	 ...
	 * @return RequestQuery
	 */
	public static function fromCookie(Request $request):RequestQuery {
	 ...
	 * @throws EmptyParameterNameException
	 */
	public function getValue(string $varName) {
		if (empty($varName)) {
			throw new EmptyParameterNameException($this);
		}
	 ...
	 */
	public function requireValue(string $varName) {
		if (($value = $this->getValue($varName)) === null) {
